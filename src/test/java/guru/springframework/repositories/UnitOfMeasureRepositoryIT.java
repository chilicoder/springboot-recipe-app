...
public class UnitOfMeasureRepositoryIT {
    ...
    public void findByUom() throws Exception {
        ...
        assertEquals(unitOfMeasureOptional.get().getUom(),"Cup");
    }
    @Test
    public void findByUomTablespoon() throws Exception {
        Optional<UnitOfMeasure> unitOfMeasureOptional = unitOfMeasureRepository.findByUom("Tablespoon");
        assertEquals(unitOfMeasureOptional.get().getUom(),"Tablespoon");
    }
